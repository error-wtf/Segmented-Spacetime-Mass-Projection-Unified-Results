...
These abbreviations appear in documentation but may need definition:

| Abbreviation | Files | Recommendation |
|--------------|-------|----------------|
| ALL | README.md | Define at first use |
| ALMA | README.md | Define at first use |
| ANTI | README.md | Define at first use |
| CAPITALIST | README.md | Define at first use |
| CD | README.md | Define at first use |
| CHANGELOG | README.md | Define at first use |
| CI | MATHEMATICAL_FORMULAS.md, MATHEMATICAL_FORMULAS_DE.md, README.md | Define at first use |
| CO | README.md | Define at first use |
| DR | README.md | Define at first use |
| EHT | PHYSICS_FOUNDATIONS_DE.md, PHYSICS_FOUNDATIONS.md, README.md | Define at first use |
| EXACTLY | PHYSICS_FOUNDATIONS.md | Define at first use |
| EXAKT | PHYSICS_FOUNDATIONS_DE.md | Define at first use |
| GB | README.md | Define at first use |
| GM | MATHEMATICAL_FORMULAS.md, PHYSICS_FOUNDATIONS_DE.md, PHYSICS_FOUNDATIONS.md (+1 more) | Define at first use |
| GRAVITY | README.md | Define at first use |
| HERE | README.md | Define at first use |
| II | README.md | Define at first use |
| JIT | CODE_IMPLEMENTATION_GUIDE.md | Define at first use |
| KB | README.md | Define at first use |
| LICENSE | README.md | Define at first use |
| LIGO | PHYSICS_FOUNDATIONS_DE.md, PHYSICS_FOUNDATIONS.md | Define at first use |
| NICHT | PHYSICS_FOUNDATIONS_DE.md | Define at first use |
| NOT | PHYSICS_FOUNDATIONS.md, README.md | Define at first use |
| OS | README.md | Define at first use |
| PHI | CODE_IMPLEMENTATION_GUIDE_DE.md, CODE_IMPLEMENTATION_GUIDE.md | Define at first use |
| QNM | README.md | Define at first use |
| SE | MATHEMATICAL_FORMULAS.md, MATHEMATICAL_FORMULAS_DE.md | Define at first use |
| SEG | README.md | Define at first use |
| SOFTWARE | README.md | Define at first use |
| SR | MATHEMATICAL_FORMULAS.md, README.md, MATHEMATICAL_FORMULAS_DE.md (+1 more) | Define at first use |
| START | README.md | Define at first use |
| TEST | CODE_IMPLEMENTATION_GUIDE.md | Define at first use |
| TL | README.md | Define at first use |
| VLT | README.md | Define at first use |
| WSL | README.md | Define at first use |
