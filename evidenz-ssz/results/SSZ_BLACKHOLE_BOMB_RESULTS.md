...
- Braidotti, M. C., Cromb, M., et al. (2024). "Experimental demonstration of the Zel'dovich effect using rotating absorbers." University of Glasgow & University of Southampton. 
  - **Source:** [LiveScience Article - Oct 2024](https://www.livescience.com/space/black-holes/physicists-create-black-hole-bomb-for-first-time-on-earth-validating-decades-old-theory)
  - **Key Result:** First lab demonstration of superradiance using rotating aluminum cylinder + magnetic field mirror
  - **Quote:** *"Components exploded"* - verified exponential amplification and spontaneous wave generation

**Theoretical Framework:**
- **Zel'dovich, Ya. B. (1971).** "Generation of Waves by a Rotating Body." JETP Letters 14, 180.
  - Original prediction of superradiance from rotating absorbers
  - Basis for black hole bomb concept
  
- **Press, W. H., & Teukolsky, S. A. (1972).** "Floating Orbits, Superradiant Scattering and the Black-hole Bomb." Nature, 238, 211-212.
  - Applied Zel'dovich effect to rotating black holes
  - Introduced mirror-cavity amplification concept

- **Casu, L., & Wrede, C. (2025).** Segmented Spacetime Mass Projection - SSZ Framework.
  - **Extension:** Segment-based damping mechanism (λ_A, σ(θ))
  - **Result:** SSZ stabilizes system (16/20 unstable modes vs 18/20 baseline)
  - **Key Finding:** φ-based geometry reduces growth rate by factor ~6.61×
...
- 2024 Experiment analog: Ring resonator → Rotating cylinder with mirror cavity
