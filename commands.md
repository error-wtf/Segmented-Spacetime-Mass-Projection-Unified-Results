...
```
python segspace_all_in_one.py all --csv ".\real_data_full.csv" --outdir ".\agent_out" --prefer-z --mode hybrid --dm-file ".\agent_out\reports\deltaM_tuning_best.json" --plots
```
