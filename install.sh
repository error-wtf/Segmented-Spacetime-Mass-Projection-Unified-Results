...
echo "  python run_ssz_validation.py           # SSZ vs GR validation (~2 min)"
echo "  python run_ssz_theory_validation.py    # 10-step ToE validation (~2 min)"
echo "  python run_complete_test_suite.py      # All tests (~5-10 min)"
echo ""
echo "Documentation:"
