...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    if args.cmd=="all":
        ...
        echo("")
        echo("CRITICAL INSIGHT: Phi corrections (Delta(M) = A*exp(-alpha*rs) + B) are")
        echo("FUNDAMENTAL to SEG. ALL successes come from phi:")
        echo("  • Photon sphere success: +72-77 percentage points from phi")
        echo("  • High velocity success: +76 percentage points from phi")
        echo("  • Overall competitiveness: +51 percentage points from phi")
        echo("  • Without phi: Total failure (0% win rate)")
        echo("")
        ...
        echo("of WHERE SEG excels (photon sphere, high v), WHERE it needs improvement (r<2),")
        echo("and WHAT makes it work (phi corrections).")
        echo("")
        echo("For complete analysis see:")
        echo("  • STRATIFIED_PAIRED_TEST_RESULTS.md - Full stratified breakdown")
        echo("  • PHI_CORRECTION_IMPACT_ANALYSIS.md - Complete phi impact analysis")
